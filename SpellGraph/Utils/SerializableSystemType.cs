...
/// https://forum.unity.com/threads/serializable-system-type-get-it-while-its-hot.187557/
/// Edit 1: Modified the original script so that it only uses assemblyQualifiedName, name and assemblyName were redundant.
/// Edit 2: Known bug -> When renaming classes that use this SerializableSystemType, you need to also rename the AssemblyQualifiedName manually in the S.O. inspector.
/// </summary>
